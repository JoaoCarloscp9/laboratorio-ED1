...
Inimigo *encontrarinimigosmaisfraco(Inimigo *vetor, int n)
{
...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        if (IsKeyPressed(KEY_SPACE))
        {
            ...
            Inimigo *alvo = encontrarinimigosmaisfraco(inimigos, TOTAL_INIMIGOS);
        ...
        DrawText("ESPACO atira no inimigo vivo com mrnot vida", 10, 10, 20, DARKGRAY);
        DrawText("c cura os inimigos vivos", 10, 35, 20, DARKGRAY);
